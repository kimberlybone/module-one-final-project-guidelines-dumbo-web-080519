...
r1 = Review.create(doctor: donald, rating: 8, content: "Likes to make a lot of jokes.", patient: kim )
r2 = Review.create(doctor: lisa, rating: 10, content: "A1 doctor.", patient: mina)
